...
-- recommended:
require'lsp_signature'.setup(signatures_cfg) -- no need to specify bufnr if you don't use toggle_key

-- You can also do this inside lsp on_attach
-- note: on_attach deprecated
require'lsp_signature'.on_attach(signatures_cfg, bufnr) -- no need to specify bufnr if you don't use toggle_key
...
vim.keymap.set('n', '<leader>ed', vim.diagnostic.open_float, { desc = "[E]rror [D]escription" })
